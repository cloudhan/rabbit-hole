...
MATMUL_KERNEL_SIGNATURE(matmul_kernel_smem_2) {
...
MATMUL_KERNEL_LAUNCH(matmul_kernel_smem_2, 256, 128, 128, 4, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_kernel_smem_2, 256, 128, 128, 8, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_kernel_smem_2, 256, 128, 128, 16, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_kernel_smem_2, 256, 128, 128, 24, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_kernel_smem_2, 256, 128, 128, 32, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_kernel_smem_2, 256, 128, 128, 40, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_kernel_smem_2, 256, 128, 128, 48, 8, 8);

MATMUL_DMODULE(m) {
  REGISTER(launch_matmul_kernel_smem_2_256t_cta128x128_smem4_thread8x8);
  REGISTER(launch_matmul_kernel_smem_2_256t_cta128x128_smem8_thread8x8);
  REGISTER(launch_matmul_kernel_smem_2_256t_cta128x128_smem16_thread8x8);
  REGISTER(launch_matmul_kernel_smem_2_256t_cta128x128_smem24_thread8x8);
  REGISTER(launch_matmul_kernel_smem_2_256t_cta128x128_smem32_thread8x8);
  REGISTER(launch_matmul_kernel_smem_2_256t_cta128x128_smem40_thread8x8);
  REGISTER(launch_matmul_kernel_smem_2_256t_cta128x128_smem48_thread8x8);
}
