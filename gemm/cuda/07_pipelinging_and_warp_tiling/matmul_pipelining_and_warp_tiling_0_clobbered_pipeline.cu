...
MATMUL_KERNEL_SIGNATURE(matmul_kernel_pipelining_and_warp_tiling_clobbered_pipeline) {
...
MATMUL_KERNEL_LAUNCH(matmul_kernel_pipelining_and_warp_tiling_clobbered_pipeline, 256, 128, 128, 8, 128, 16, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_kernel_pipelining_and_warp_tiling_clobbered_pipeline, 256, 128, 128, 8, 64, 32, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_kernel_pipelining_and_warp_tiling_clobbered_pipeline, 256, 128, 128, 8, 32, 64, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_kernel_pipelining_and_warp_tiling_clobbered_pipeline, 256, 128, 128, 8, 16, 128, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_kernel_pipelining_and_warp_tiling_clobbered_pipeline, 256, 128, 128, 16, 128, 16, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_kernel_pipelining_and_warp_tiling_clobbered_pipeline, 256, 128, 128, 16, 64, 32, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_kernel_pipelining_and_warp_tiling_clobbered_pipeline, 256, 128, 128, 16, 32, 64, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_kernel_pipelining_and_warp_tiling_clobbered_pipeline, 256, 128, 128, 16, 16, 128, 8, 8);

MATMUL_DMODULE(m) {
  REGISTER(launch_matmul_kernel_pipelining_and_warp_tiling_clobbered_pipeline_256t_cta128x128_smem8_warp128x16_thread8x8);
  REGISTER(launch_matmul_kernel_pipelining_and_warp_tiling_clobbered_pipeline_256t_cta128x128_smem8_warp64x32_thread8x8);
  REGISTER(launch_matmul_kernel_pipelining_and_warp_tiling_clobbered_pipeline_256t_cta128x128_smem8_warp32x64_thread8x8);
  REGISTER(launch_matmul_kernel_pipelining_and_warp_tiling_clobbered_pipeline_256t_cta128x128_smem8_warp16x128_thread8x8);
  REGISTER(launch_matmul_kernel_pipelining_and_warp_tiling_clobbered_pipeline_256t_cta128x128_smem16_warp128x16_thread8x8);
  REGISTER(launch_matmul_kernel_pipelining_and_warp_tiling_clobbered_pipeline_256t_cta128x128_smem16_warp64x32_thread8x8);
  REGISTER(launch_matmul_kernel_pipelining_and_warp_tiling_clobbered_pipeline_256t_cta128x128_smem16_warp32x64_thread8x8);
  REGISTER(launch_matmul_kernel_pipelining_and_warp_tiling_clobbered_pipeline_256t_cta128x128_smem16_warp16x128_thread8x8);
}
