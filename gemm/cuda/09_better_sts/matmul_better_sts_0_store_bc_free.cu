...
MATMUL_KERNEL_SIGNATURE(matmul_kernel_better_sts_0_store_bc_free) {
...
MATMUL_KERNEL_LAUNCH(matmul_kernel_better_sts_0_store_bc_free, 256, 128, 128, 8, 64, 32, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_kernel_better_sts_0_store_bc_free, 256, 128, 128, 8, 32, 64, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_kernel_better_sts_0_store_bc_free, 256, 128, 128, 16, 64, 32, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_kernel_better_sts_0_store_bc_free, 256, 128, 128, 16, 32, 64, 8, 8);

MATMUL_DMODULE(m) {
  REGISTER(launch_matmul_kernel_better_sts_0_store_bc_free_256t_cta128x128_smem8_warp64x32_thread8x8);
  REGISTER(launch_matmul_kernel_better_sts_0_store_bc_free_256t_cta128x128_smem8_warp32x64_thread8x8);
  REGISTER(launch_matmul_kernel_better_sts_0_store_bc_free_256t_cta128x128_smem16_warp64x32_thread8x8);
  REGISTER(launch_matmul_kernel_better_sts_0_store_bc_free_256t_cta128x128_smem16_warp32x64_thread8x8);
}
