...
MATMUL_KERNEL_SIGNATURE(matmul_kernel_thread_tiling_1) {
  // original matrix
...
MATMUL_KERNEL_LAUNCH(matmul_kernel_thread_tiling_1, 64, 32, 32, 4, 4);
MATMUL_KERNEL_LAUNCH(matmul_kernel_thread_tiling_1, 64, 64, 32, 8, 4);
MATMUL_KERNEL_LAUNCH(matmul_kernel_thread_tiling_1, 64, 64, 64, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_kernel_thread_tiling_1, 128, 32, 32, 4, 2);
MATMUL_KERNEL_LAUNCH(matmul_kernel_thread_tiling_1, 128, 64, 32, 4, 4);
MATMUL_KERNEL_LAUNCH(matmul_kernel_thread_tiling_1, 256, 32, 32, 2, 2);
MATMUL_KERNEL_LAUNCH(matmul_kernel_thread_tiling_1, 256, 64, 32, 4, 2);
MATMUL_KERNEL_LAUNCH(matmul_kernel_thread_tiling_1, 256, 64, 64, 4, 4);
MATMUL_KERNEL_LAUNCH(matmul_kernel_thread_tiling_1, 256, 128, 64, 8, 4);
MATMUL_KERNEL_LAUNCH(matmul_kernel_thread_tiling_1, 256, 128, 128, 8, 8);

MATMUL_DMODULE(m) {
  REGISTER(launch_matmul_kernel_thread_tiling_1_64t_cta32x32_thread4x4);
  REGISTER(launch_matmul_kernel_thread_tiling_1_64t_cta64x32_thread8x4);
  REGISTER(launch_matmul_kernel_thread_tiling_1_64t_cta64x64_thread8x8);
  REGISTER(launch_matmul_kernel_thread_tiling_1_128t_cta32x32_thread4x2);
  REGISTER(launch_matmul_kernel_thread_tiling_1_128t_cta64x32_thread4x4);
  REGISTER(launch_matmul_kernel_thread_tiling_1_256t_cta32x32_thread2x2);
  REGISTER(launch_matmul_kernel_thread_tiling_1_256t_cta64x32_thread4x2);
  REGISTER(launch_matmul_kernel_thread_tiling_1_256t_cta64x64_thread4x4);
  REGISTER(launch_matmul_kernel_thread_tiling_1_256t_cta128x64_thread8x4);
  REGISTER(launch_matmul_kernel_thread_tiling_1_256t_cta128x128_thread8x8);
}
