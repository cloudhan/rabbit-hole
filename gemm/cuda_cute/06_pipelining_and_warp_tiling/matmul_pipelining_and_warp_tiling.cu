...
__launch_bounds__(NumThreads, 2)
    MATMUL_KERNEL_SIGNATURE(matmul_pipelining_and_warp_tiling) {
  ...
  const auto stripe_sA = local_tile(sA, make_tile(Int<ThreadShapeM>{}, Int<SmemShapeK>{}), make_coord(cta_thread_i / ThreadShapeM));
  const auto stripe_sB = local_tile(sB, make_tile(Int<ThreadShapeN>{}, Int<SmemShapeK>{}), make_coord(cta_thread_j / ThreadShapeN));
...
MATMUL_KERNEL_LAUNCH(matmul_pipelining_and_warp_tiling, 256, 128, 128, 4, 32, 64, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_pipelining_and_warp_tiling, 256, 128, 128, 4, 64, 32, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_pipelining_and_warp_tiling, 256, 128, 128, 8, 32, 64, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_pipelining_and_warp_tiling, 256, 128, 128, 8, 64, 32, 8, 8);

MATMUL_DMODULE(m) {
  REGISTER(launch_matmul_pipelining_and_warp_tiling_256t_cta128x128_smem4_warp32x64_thread8x8);
  REGISTER(launch_matmul_pipelining_and_warp_tiling_256t_cta128x128_smem4_warp64x32_thread8x8);
  REGISTER(launch_matmul_pipelining_and_warp_tiling_256t_cta128x128_smem8_warp32x64_thread8x8);
  REGISTER(launch_matmul_pipelining_and_warp_tiling_256t_cta128x128_smem8_warp64x32_thread8x8);
}
