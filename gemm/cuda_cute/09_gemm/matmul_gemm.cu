...
__launch_bounds__(NumThreads, 2)
    MATMUL_KERNEL_SIGNATURE(matmul_kernel_gemm) {
...
MATMUL_KERNEL_LAUNCH(matmul_kernel_gemm, 256, 128, 128, 8, 32, 64, 8, 8);
MATMUL_KERNEL_LAUNCH(matmul_kernel_gemm, 256, 128, 128, 8, 64, 32, 8, 8);

MATMUL_DMODULE(m) {
  REGISTER(launch_matmul_kernel_gemm_256t_cta128x128_smem8_warp32x64_thread8x8);
  REGISTER(launch_matmul_kernel_gemm_256t_cta128x128_smem8_warp64x32_thread8x8);
}
